...
class katagtp():
	...
	def analyze_black(self):
		self.write("kata-genmove_analyze black")
	
	def analyze_white(self):
		self.write("kata-genmove_analyze white")
	
	def appendAns(self,player_color,ans):
		self.history.append([player_color.lower(),ans])
